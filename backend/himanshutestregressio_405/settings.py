"""
Django settings for himanshutestregressio_405 project.
...
ROOT_URLCONF = 'himanshutestregressio_405.urls'
...
WSGI_APPLICATION = 'himanshutestregressio_405.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "himanshutestregressio_405 API",
    "DESCRIPTION": "API documentation for himanshutestregressio_405 App",
    "VERSION": "v1",
}
